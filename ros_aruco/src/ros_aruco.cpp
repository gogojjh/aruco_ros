...
int main(int argc,char **argv) {
	...
	TheCameraParameters.readFromXMLFile("/home/shashank/catkin_ws/src/ros_aruco/data/left.yaml");
    ...
    MDetector.setDictionary("ARUCO",0.f);  //set type of marker from dictionary.h
